...
class DbMigrations
{
    ...
    public static function createBooksTable()
    {
        ...
        $sql = 'CREATE TABLE IF NOT EXISTS books (
            ...
            CONSTRAINT FK_PublisherBook FOREIGN KEY (publisher_id )
    ...
    public static function createBooksAuthorsRelationshipTable()
    {
        ...
        $sql = 'CREATE TABLE IF NOT EXISTS books_authors_relationship (
            ...
            CONSTRAINT FK_AuthorBook FOREIGN KEY (author_id) REFERENCES authors(id) ON DELETE CASCADE ,
            CONSTRAINT FK_BookAuthor FOREIGN KEY (book_id) REFERENCES books(id) ON DELETE CASCADE 
            )';
        $conn->exec($sql);
    }
